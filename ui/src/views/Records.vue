      ...
      <aside class="detail-panel">
        <template v-if="selectedDetail">
          ...
          <div class="detail-actions" v-if="canMutate(selectedDetail)">
            <button class="text-action" @click="openEdit(selectedDetail)">{{ t('records.actions.edit') }}</button>
