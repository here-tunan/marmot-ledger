...
function bucketTypeColor(type) {
  const colors = {
    cash: '#2f7d5c', wallet: '#2f7d5c', bank: '#06b6d4', credit: '#ef4444',
...
const netWorthTrendOptions = computed(() => {
  ...
  return {
    ...
    series: [
      ...
      { name: t('dashboard.netWorthTrend.netWorth'), type: 'line', smooth: true, data: netWorth, lineStyle: { color: '#2f7d5c', width: 4 }, itemStyle: { color: '#2f7d5c' }, symbol: 'circle', symbolSize: 7 },
    ],
  }
})

const categoryFallbackColors = ['#2f7d5c', '#2f7d5c', '#ef4444', '#f59e0b', '#7c3aed', '#06b6d4', '#84cc16', '#ec4899', '#14b8a6', '#a855f7']
